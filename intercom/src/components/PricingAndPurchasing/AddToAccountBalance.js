...
class AddToAccountBalance extends Component {
    ...
    saveCardAndCharge = async() => {
        ...
        try {
            ...
            const source = await this.createSource();
            const createSourceAndAttachToCustomerResponse = await this.attachSourceToCustomer(source);
            console.log('createSourceAndAttachToCustomerResponse: ', createSourceAndAttachToCustomerResponse); 
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <div>
                                <h5>I want to save this credit card for later. </h5>
                                {/* <button onClick = {this.createPaymentIntentSubmitHandler}>create payment intent</button> */}
                                <button onClick = {this.saveCardAndCharge}>saveCardAndCharge</button>
